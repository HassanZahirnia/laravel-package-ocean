...
export const laravelPackages: Package[] = [
    {
        ...
        author: 'owen-it',
        stars: 2570,
        keywords: ['log', 'history', 'activity', 'tracking'],
    ...
    },
    {
        ...
        author: 'spatie',
        stars: 5286,
        keywords: ['image', 'pdf', 'video', 'upload', 'download', 'optimize', 'conversion', 'storage', 'filesystem'],
    ...
    },
    {
        ...
        author: 'spatie',
        stars: 11105,
        keywords: ['gate', 'authorization', 'guard', 'admin', 'team'],
    ...
    },
    {
        ...
        author: 'barryvdh',
        stars: 15038,
        keywords: ['profiling', 'profiler', 'collector', 'memory', 'events'],
    ...
    },
    {
        ...
        author: 'spatie',
        stars: 5193,
        keywords: ['files', 'encrypt', 'dump', 'database', 'copy', 'remote'],
    ...
    },
    {
        ...
        author: 'mcamara',
        stars: 3109,
        keywords: ['language', 'locale', 'translate', 'translation', 'internationalization'],
    ...
    },
    {
        ...
        author: 'rebing',
        stars: 1957,
        keywords: ['facebook', 'query', 'mutation', 'middleware'],
    ...
    },
    {
        ...
        author: 'ralphjsmit',
        stars: 318,
        keywords: ['opengraph', 'twitter', 'meta', 'json-ld', 'schema.org', 'search', 'google', 'bing', 'robots', 'sitemap', 'favicon', 'breadcrumbs'],
    ...
    },
    {
        ...
        author: 'pestphp',
        stars: 6657,
        keywords: ['expectations', 'assert', 'phpunit', 'mocking', 'optimize', 'coverage', 'higher order testing', 'architecture', 'dataset'],
    ...
    },
    {
        ...
        author: 'laravel',
        stars: 2209,
        keywords: ['invoice', 'card', 'gateway', 'coupon', 'cancellation', 'management'],
    ...
    },
    {
        ...
        author: 'spatie',
        stars: 1097,
        keywords: ['protection', 'captcha', 'request'],
    ...
    },
    {
        ...
        author: 'aimeos',
        stars: 6093,
        keywords: ['warehouse', 'multi tentant', 'product', 'vendor', 'subscription', 'price', 'graphql', 'admin', 'voucher'],
    ...
    },
    {
        ...
        author: 'filamentphp',
        stars: 6190,
        keywords: ['dashboard', 'livewire', 'user', 'widget', 'menu', 'bar', 'dark', 'notification', 'chart', 'stats', 'actions', 'security', 'records'],
    ...
    },
    {
        ...
        author: 'lorisleiva',
        stars: 2023,
        keywords: ['controller', 'jobs', 'listener', 'commands', 'service', 'optimize', 'refactor', 'components'],
    ...
    },
    {
        ...
        author: 'blade-ui-kit',
        stars: 1768,
        keywords: ['css', 'html', 'directive', 'generate'],
