...
const categoriesWithPackagesCount = categories.map((category) => {
    return {
        name: category,
                ...
                <div
                    ...
                    <div
                        ...
                        :class="{
                            ...
                            'bg-slate-200 text-[#4B5563] dark:bg-slate-500/20 dark:text-slate-300': category.name === 'API' && selectedCategory === 'API',
