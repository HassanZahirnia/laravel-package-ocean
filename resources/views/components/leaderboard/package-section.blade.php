        ...
        >
            ...
            >
                @foreach ($this->packages as $package)
                    <x-leaderboard.package-card :$package />
                @endforeach
            </div>
            ...
            @if ($this->packages->total() === 0)
                <div class="flex justify-center px-5 pt-8">
                    <div class="text-[#6A7789] dark:text-[#96A5BB]">
                        No results found.
                    </div>
                </div>
            @endif
